...
export const ConsultaVentas extends  = () => {
        ...
        <Fragment>
            {loading ? <i className="fa fa-refresh fa-spin fa-3x fa-fw"></i> :(
                ...
                <div className="col-9 text-center">
                    <MetaData title="Consulta Ventas"></MetaData>
                <br></br>
               ...
               <table className="table">
                <thead className="table-az">
                    <tr>
                        ...
                        <th className='col-2 text-right'>Precio x Kg</th>
                        <th className='col-2 text-right'>Precio Total</th>
